...
_CACHE_DEFAULT_URL = env(
    "CACHE_DEFAULT_URL", default=env("REDIS_URL", default="redis://localhost:6379/0")
)
_CACHE_SESSIONS_URL = env(
    "CACHE_SESSIONS_URL", default=env("REDIS_URL", default="redis://localhost:6379/0")
)
_CACHE_TENANT_URL = env(
    "CACHE_TENANT_URL", default=env("REDIS_URL", default="redis://localhost:6379/0")
)
