...
class MaintenanceModeMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        # Allow health/static/debug paths before touching PlatformConfig. Health
        # checks must stay independent from database availability so platforms
        # like Railway can determine whether the web process is alive.
