...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    def stats(self, request):
        ...
        stats = {
            ...
            "corporate_customers": queryset.filter(
...
class VehicleViewSet(viewsets.ModelViewSet):
    ...
    search_fields = ["registration_number", "make", "model", "chassis_number"]
...
class PolicyViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        tenant = get_current_tenant()
        return Policy.objects.for_tenant(tenant).select_related(
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        tenant = get_current_tenant()
        return Payment.objects.for_tenant(tenant).select_related(
            "policy", "policy__vehicle"
        )
    ...
    def verify(self, request, pk=None):
        ...
        return Response({"status": "Payment verified", "policy_activated": False})
